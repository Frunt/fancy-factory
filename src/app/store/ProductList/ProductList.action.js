...
export const UPDATE_WIDGET_PRODUCTS = 'UPDATE_WIDGET_PRODUCTS';
...
export const updateWidgetProducts = (items, total_count, additionalType) => ({
    type: UPDATE_WIDGET_PRODUCTS,
    items,
    total_count,
    additionalType
});
