...
export class ProductActionsContainer extends PureComponent {
    ...
    state = {quantity: 1, customizable_options: {}};

    containerFunctions = {
        showOnlyIfLoaded: this.showOnlyIfLoaded.bind(this),
        getIsOptionInCurrentVariant: this.getIsOptionInCurrentVariant.bind(this),
        setQuantity: this.setQuantity.bind(this),
        setCustomizableOptions: this.setCustomizableOptions.bind(this),
    ...
    setCustomizableOptions(option) {
        const {customizable_options} = this.state;
        customizable_options[option.id] = option;
        this.setState({...customizable_options})
    }
