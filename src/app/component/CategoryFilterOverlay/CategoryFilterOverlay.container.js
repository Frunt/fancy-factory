...
export class CategoryFilterOverlayContainer extends PureComponent {
    ...
    containerFunctions = {
        ...
        clearCustomFilter: this.clearCustomFilter.bind(this),
        clearPriceRange: this.clearPriceRange.bind(this),
        clearLubricantRange: this.clearLubricantRange.bind(this)
    };
    ...
    clearCustomFilter(requestVar) {
        const {updateFilter} = this.props;
        updateFilter(requestVar, [])
    }
    ...
    clearLubricantRange() {
        const {updateLubricantRange} = this.props;
        const lubricantValue = {min: [], max: []};
        updateLubricantRange(lubricantValue)
    }
