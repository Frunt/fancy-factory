...
export class OrderQuery {
    ...
    _prepareShippingInfo(isList) {
        return new Field('shipping_info')
            .addFieldList(this._prepareShippingInfoFields(isList));
    }

    _prepareShippingInfoFields(isList) {
        return [
            'tracking_numbers',
            ...!isList ? ([
                'shipping_method',
    ...
    _getTrackingInfo() {
        return new Field('tracking_history').addFieldList(['date', 'location', 'status'])
    }
    ...
    _getOrderItemsFields(isList) {
        return [
            ...
            this._prepareShippingInfo(isList),
            ...(!isList ? [
